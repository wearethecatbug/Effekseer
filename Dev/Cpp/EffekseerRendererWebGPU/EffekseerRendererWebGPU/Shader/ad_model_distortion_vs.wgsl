...
fn _main_u0028_struct_u002d_VS_Input_u002d_vf3_u002d_vf3_u002d_vf3_u002d_vf3_u002d_vf2_u002d_vf2_u002d_vf4_u002d_u11_u003b(Input: ptr<function, VS_Input>) -> VS_Output {
    ...
    let _e86 = (*Input).Index;
    index = _e86;
    let _e87 = index;
    let _e90 = _372_.mModel_Inst[_e87];
    mModel = transpose(_e90);
    let _e92 = index;
    let _e95 = _372_.fUV[_e92];
    uv_2 = _e95;
    let _e96 = index;
    let _e99 = _372_.fAlphaUV[_e96];
    alphaUV_1 = _e99;
    let _e100 = index;
    let _e103 = _372_.fUVDistortionUV[_e100];
    uvDistortionUV_1 = _e103;
    let _e104 = index;
    let _e107 = _372_.fBlendUV[_e104];
    blendUV_1 = _e107;
    let _e108 = index;
    let _e111 = _372_.fBlendAlphaUV[_e108];
    blendAlphaUV_1 = _e111;
    let _e112 = index;
    let _e115 = _372_.fBlendUVDistortionUV[_e112];
    blendUVDistortionUV_1 = _e115;
    let _e116 = index;
    let _e119 = _372_.fModelColor[_e116];
    let _e121 = (*Input).Color;
    modelColor = (_e119 * _e121);
    let _e123 = index;
    let _e127 = _372_.fFlipbookIndexAndNextRate[_e123][0u];
    flipbookIndexAndNextRate_1 = _e127;
    let _e128 = index;
    let _e132 = _372_.fModelAlphaThreshold[_e128][0u];
    modelAlphaThreshold_1 = _e132;
    ...
    let _e135 = (*Input).Pos[0u];
    let _e138 = (*Input).Pos[1u];
    let _e141 = (*Input).Pos[2u];
    localPosition = vec4<f32>(_e135, _e138, _e141, 1f);
    let _e143 = localPosition;
    let _e144 = mModel;
    worldPos = (_e143 * _e144);
    let _e146 = worldPos;
    let _e148 = _372_.mCameraProj;
    Output.PosVS = (_e146 * transpose(_e148));
    let _e153 = (*Input).UV1_;
    outputUV = _e153;
    let _e155 = outputUV[0u];
    let _e157 = uv_2[2u];
    let _e160 = uv_2[0u];
    outputUV[0u] = ((_e155 * _e157) + _e160);
    let _e164 = outputUV[1u];
    let _e166 = uv_2[3u];
    let _e169 = uv_2[1u];
    outputUV[1u] = ((_e164 * _e166) + _e169);
    let _e174 = _372_.mUVInversed[0u];
    let _e177 = _372_.mUVInversed[1u];
    let _e179 = outputUV[1u];
    outputUV[1u] = (_e174 + (_e177 * _e179));
    let _e184 = outputUV[0u];
    Output.UV_Others[0u] = _e184;
    let _e188 = outputUV[1u];
    Output.UV_Others[1u] = _e188;
    let _e193 = (*Input).Normal[0u];
    let _e196 = (*Input).Normal[1u];
    let _e199 = (*Input).Normal[2u];
    localNormal = vec4<f32>(_e193, _e196, _e199, 0f);
    let _e203 = (*Input).Binormal[0u];
    let _e206 = (*Input).Binormal[1u];
    let _e209 = (*Input).Binormal[2u];
    localBinormal = vec4<f32>(_e203, _e206, _e209, 0f);
    let _e213 = (*Input).Tangent[0u];
    let _e216 = (*Input).Tangent[1u];
    let _e219 = (*Input).Tangent[2u];
    localTangent = vec4<f32>(_e213, _e216, _e219, 0f);
    let _e221 = localNormal;
    let _e222 = mModel;
    worldNormal = (_e221 * _e222);
    let _e224 = localBinormal;
    let _e225 = mModel;
    worldBinormal = (_e224 * _e225);
    let _e227 = localTangent;
    let _e228 = mModel;
    worldTangent = (_e227 * _e228);
    let _e230 = worldNormal;
    worldNormal = normalize(_e230);
    let _e232 = worldBinormal;
    worldBinormal = normalize(_e232);
    let _e234 = worldTangent;
    worldTangent = normalize(_e234);
    let _e236 = worldPos;
    let _e237 = worldTangent;
    let _e240 = _372_.mCameraProj;
    Output.ProjTangent = ((_e236 + _e237) * transpose(_e240));
    let _e244 = worldPos;
    let _e245 = worldBinormal;
    let _e248 = _372_.mCameraProj;
    Output.ProjBinormal = ((_e244 + _e245) * transpose(_e248));
    let _e252 = modelColor;
    Output.Color = _e252;
    let _e255 = (*Input).UV1_;
    param_19 = _e255;
    let _e257 = Output.UV_Others;
    param_1_2 = _e257.xy;
    let _e259 = alphaUV_1;
    param_2_2 = _e259;
    let _e260 = uvDistortionUV_1;
    param_3_2 = _e260;
    let _e261 = blendUV_1;
    param_4_2 = _e261;
    let _e262 = blendAlphaUV_1;
    param_5_2 = _e262;
    let _e263 = blendUVDistortionUV_1;
    param_6_2 = _e263;
    let _e264 = flipbookIndexAndNextRate_1;
    param_7_1 = _e264;
    let _e265 = modelAlphaThreshold_1;
    param_8_1 = _e265;
    let _e266 = Output;
    param_9_1 = _e266;
    let _e267 = param_19;
    ...
    let _e276 = param_9_1;
    param_29 = _e276;
    CalculateAndStoreAdvancedParameter_u0028_vf2_u003b_vf2_u003b_vf4_u003b_vf4_u003b_vf4_u003b_vf4_u003b_vf4_u003b_f1_u003b_f1_u003b_struct_u002d_VS_Output_u002d_vf4_u002d_vf4_u002d_vf4_u002d_vf4_u002d_vf4_u002d_vf4_u002d_vf4_u002d_vf4_u002d_vf41_u003b((&param_20), (&param_21), (&param_22), (&param_23), (&param_24), (&param_25), (&param_26), (&param_27), (&param_28), (&param_29));
    let _e277 = param_29;
    param_9_1 = _e277;
    let _e278 = param_9_1;
    Output = _e278;
    let _e280 = Output.PosVS;
    Output.PosP = _e280;
    let _e282 = Output;
    return _e282;
}
...
fn main_1() {
    ...
    let _e75 = flattenTemp.UV_Others;
    _entryPointOutput_UV_Others = _e75;
    let _e77 = flattenTemp.ProjBinormal;
    _entryPointOutput_ProjBinormal = _e77;
    let _e79 = flattenTemp.ProjTangent;
    _entryPointOutput_ProjTangent = _e79;
    let _e81 = flattenTemp.PosP;
    _entryPointOutput_PosP = _e81;
    let _e83 = flattenTemp.Color;
    _entryPointOutput_Color = _e83;
    let _e85 = flattenTemp.Alpha_Dist_UV;
    _entryPointOutput_Alpha_Dist_UV = _e85;
    let _e87 = flattenTemp.Blend_Alpha_Dist_UV;
    _entryPointOutput_Blend_Alpha_Dist_UV = _e87;
    let _e89 = flattenTemp.Blend_FBNextIndex_UV;
    _entryPointOutput_Blend_FBNextIndex_UV = _e89;
    return;
}
...
fn main(@location(0) Input_Pos: vec3<f32>, @location(1) Input_Normal: vec3<f32>, @location(2) Input_Binormal: vec3<f32>, @location(3) Input_Tangent: vec3<f32>, @location(4) Input_UV1_: vec2<f32>, @location(5) Input_UV2_: vec2<f32>, @location(6) Input_Color: vec4<f32>, @builtin(instance_index) gl_InstanceIndex: u32) -> VertexOutput {
    ...
    main_1();
    let _e28 = unnamed.gl_Position.y;
    unnamed.gl_Position.y = -(_e28);
    let _e30 = unnamed.gl_Position;
    let _e31 = _entryPointOutput_UV_Others;
    let _e32 = _entryPointOutput_ProjBinormal;
    let _e33 = _entryPointOutput_ProjTangent;
    let _e34 = _entryPointOutput_PosP;
    let _e35 = _entryPointOutput_Color;
    let _e36 = _entryPointOutput_Alpha_Dist_UV;
    let _e37 = _entryPointOutput_Blend_Alpha_Dist_UV;
    let _e38 = _entryPointOutput_Blend_FBNextIndex_UV;
